...
def get_all_reports(db: Session, creator_id: int, reported_id: int, current_user: UserBase | AdminBase):
...
#handle report
def handle_report(db: Session, id: int , report_status: str, current_user: UserBase | AdminBase):
