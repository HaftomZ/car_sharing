...
INSERT INTO payments (payment_id, booking_id, user_id, amount, currency, status, payment_method, transaction_reference,created_at, refund_status,admin_approved)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
'''
